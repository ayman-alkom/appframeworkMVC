(function(c){var h=document.location.protocol+"//"+document.location.host,k=location.href,b="state"in window.history;c.mvc={};c.mvc={};c.mvc._app;c.mvc.app=function(){c.mvc._app=this};c.mvc.app.prototype={_loadTimer:null,_modelsReady:!1,_controllersReady:!1,_loadedListeners:[],_modelsLoaded:0,_totalModels:0,_controllersDir:"controllers/",_modelsDir:"models/",_templateType:"text/x-dot-template",_hasModels:!0,_useHistory:!1,_html5Pop:function(a){var f=!b&&location.href!=k;b=!0;f||c.mvc.route(document.location.href,
...
a},setViewType:function(a){this._templateType=a},ready:function(a){if(this.loaded)a();else c(document).one("afmvc:loaded",a)},loadControllers:function(a){var b=this;c(document).ready(function(){"string"===typeof a&&(a=[a]);for(var d=0;d<a.length;d++){var e=document.createElement("script");e.src=b._controllersDir+a[d]+".js";e.onerror=function(a){console.log("error ",a)};c("head").append(e);b._loadedListeners[a[d]]=1;b._loadedListeners.length++;c(document).one(a[d]+":ready",function(a){delete b._loadedListeners[a.data.name];
b._loadedListeners.length--;0==b._loadedListeners.length&&(b._controllersReady=!0,b._modelsReady||!b._hasModels?c(document).trigger("afmvc:loaded"):b._loadTimer=setTimeout(function(){b._modelsReady=!0;b._controllersReady&&c(document).trigger("afmvc:loaded")},1500))});delete e}})},loadModels:function(a){var b=this;clearTimeout(this._loadTimer);c(document).ready(function(){"string"===typeof a&&(a=[a]);b._totalModels=a.length;for(var d=0;d<a.length;d++){var e=document.createElement("script");e.src=b._modelsDir+
a[d]+".js";e.onload=function(){b._modelsLoaded++;b._modelsLoaded>=b._totalModels&&(b._modelsReady=!0,b._controllersReady&&c(document).trigger("afmvc:loaded"))};e.onerror=function(a){console.log("error ",a)};c("head").append(e);delete e}})}};c.mvc.route=function(a,b,d){"string"!==typeof a&&(a.nodeName&&"a"==a.nodeName.toLowerCase())&&(a=a.href);if("string"!==typeof a)throw"Invalid route parameter.  String or <a> expected";var e,l,g=a;0===a.indexOf(h)&&(a=a.substring(h.length,a.length));"/"==a[0]&&
(a=a.substr(1));"/"==a[a.length-1]&&(a=a.slice(0,-1));a=a.split("/");1<a.length?(e=a.splice(0,1),l=a.splice(0,1)):(e=a[0],l="default");if(c.mvc.controller[e]&&c.mvc.controller[e].hasOwnProperty(l)){b&&b.preventDefault();try{c.mvc.controller[e][l].apply(c.mvc.controller[e],a)}catch(q){console.log(q.message)}c.mvc._app._useHistory&&!0!==d&&window.history.pushState(g,g,g);return!0}return!1};c.mvc.addRoute=function(a,b){0===a.indexOf(h)&&(a=a.substring(h.length,a.length));"/"==a[0]&&(a=a.substr(1));a=
a.split("/");if(1<a.length)var d=a.splice(0,1),e=a.splice(0,1);else d=a[0],e="default";c.mvc.controller[d]||(c.mvc.controller[d]={});c.mvc.controller[d][e]=b};if(c.ui)c.ui.customClickHandler=c.mvc.route;else c(document).on("click","a",function(a){c.mvc.route(a.target,a)})})(af);
