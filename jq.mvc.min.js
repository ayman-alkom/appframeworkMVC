...
!1,a[c]=f.views.length||Object.keys(f.views).length,f.views){var h=typeof i==="number"?f.views[i]:i;!g[h]&&jq("#"+h).length==0&&(b.mvc.controller.addView(f.views[i],c,h),g[h]=1)}j&&(b(document).trigger(c+":ready",{name:c}),d[c]&&d[c].init.apply(d[c]));return b.mvc.controller[c]};b.mvc.route=function(a,e){a=String(a);a.indexOf(h)===0&&(a=a.substring(h.length,a.length));a[0]=="/"&&(a=a.substr(1));a=a.split("/");if(a.length>1)var d=a.splice(0,1),g=a.splice(0,1);else d=a[0],g="default";if(b.mvc.controller[d]&&
b.mvc.controller[d].hasOwnProperty(g))return e&&e.preventDefault(),b.mvc.controller[d][g].apply(b.mvc.controller[d],a),!0;return!1};b.mvc.addRoute=function(a,d){a.indexOf(h)===0&&(a=a.substring(h.length,a.length));a[0]=="/"&&(a=a.substr(1));a=a.split("/");if(a.length>1)var e=a.splice(0,1),g=a.splice(0,1);else e=a[0],g="default";b.mvc.controller[e]||(b.mvc.controller[e]={});b.mvc.controller[e][g]=d};b.mvc.controller.addView=function(c,f,g){b.get(c,function(c){b(document.body).append(b("<script type='"+
b.mvc.app._templateType+"' id='"+g+"'>"+c+"<\/script>"));e[f]++;e[f]==a[f]&&(b(document).trigger(f+":ready",{name:f}),d[f]&&d[f].init.apply(d[f]))})};if(b.ui)b.ui.customClickHandler=b.mvc.route;else b(document).on("click","a",function(a){b.mvc.route(a.target.href,a)})})(jq);
